	...
	return (
		...
		>
			...
			<Canvas padding={{ top: 24, left: 24 }}>
				<Label index={0} text="Zaridium" font={Enum.Font.GothamBlack} size={20} position={px(0, 0)} />
				<Label index={1} text={VERSION_TAG} position={px(0, 40)} />
				<Label index={2} text="By MidasRX" position={px(0, 63)} transparency={0.15} />
				<Label index={3} text="Pls star repo" position={px(0, 86)} transparency={0.3} />
				<Label index={4} text="MidasRX/Zaridium" position={new UDim2(0, 0, 1, -40)} transparency={0.45} />
			</Canvas>
		</Card>
	);
}
